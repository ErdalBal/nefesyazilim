...
<div class="card">
    <div class="card-body">
        <div class="d-lg-flex align-items-center mb-4 gap-3">
          ...
          {{-- <div class="ms-auto"><a href="{{route('category.create')}}" class="btn btn-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>Etkinlik Kategori Ekle</a></div> --}}
...
<div class="table-responsive">
    ...
    <table class="table mb-0">
        <thead class="table-light">
            <tr>
                <th>NO#</th>
                <th>Post</th>
                <th>Yorum Yapan Ad</th>
                <th>Yorum Yapan Eposta</th>
                <th>Yorum</th>
                <th>Status</th>
                <th>Actions</th>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <div class="d-flex order-actions">
                        <a href="{{route('commentpost.edit',$item->id)}}" class=""><i class='bx bxs-edit'></i></a>
    ...
    <nav style="margin-top: 25px;position: absolute;right: 0px;" aria-label="paginate">
        ...
        @else
        <li class="page-item"><a class="page-link" href="{{ $commentlist->previousPageUrl() }}" tabindex="-1" >Önceki</a>
        </li>
    ...
    {{-- Sayfa Numaraları --}}
    @foreach ($commentlist->links()->elements[0] as $page => $url)
    @if ($page == $commentlist->currentPage())
...
@endforeach
 ...
 <li class="page-item"><a class="page-link" href="{{ $commentlist->nextPageUrl() }}">Sonraki</a></li>
@else
...
@section('js')
    <script>
          ...
          var deleteUrl = "{{ route('commentpost.delete', ':id') }}";
        $(function(){
